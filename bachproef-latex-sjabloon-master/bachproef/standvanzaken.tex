...
MDT maakt hiervoor gebruik van een task sequence. Nadat deze task sequence is aangemaakt kan de PXE boot van het nieuwe systeem worden uitgevoerd. Hiervoor is een centraal punt nodig dat het nieuwe apparaat kan aanspreken. Bij MDT wordt dit een sharepoint genoemd, meer bepaald een deployment share. \autocite{Goessens2020}
...
\subsection{Verschil tussen Lite Touch en Zero Touch deployment}
Beide deployment tools maken gebruik van een lite touch of een zero touch installatie. Bij een lite touch installatie is er een beperkte nood aan user input en bij een zero touch installatie is er geen user input vereist. Zero touch deployment is een volledig geautomatiseerde deployment schema. Bovendien vereist Lite Touch een minimale infrastructuur, terwijl voor ZeroTouch Deployment een permanente netwerkverbinding nodig is. \autocite(Lithmee2019)

Met Zero Touch kunnen systeembeheerders efficiënt nieuwe computers aan het netwerk toevoegen en ervoor zorgen dat ze aan alle eisen voldoen. Omdat alle apparaten dezelfde structuur hebben, zijn deze bovendien gemakkelijker te onderhouden dan wanneer elke computer een andere structuur heeft. \autocite{Goessens2020}
